...
def load_whu_buildings_semantic(img_dir, gt_dir):
    ret = []
    for image_file, gt_file in _get_whu_buildings_files(img_dir, gt_dir):
        ret.append(
            {
...
def _get_whu_buildings_files(image_dir, gt_dir):
    files = []
