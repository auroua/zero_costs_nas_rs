...
def _get_builtin_metadata(dataset_name):
    ...
    if dataset_name == "coco_panoptic_separated":
        ...
        meat = {}
        stuff_dataset_id_to_contiguous_id = {}
        meat["classes"] = ["bg", "road"]
        meat["stuff_classes"] = ["bg", "road"]
        for i, _ in enumerate(meat["stuff_classes"]):
            stuff_dataset_id_to_contiguous_id[i] = i
        meat["stuff_dataset_id_to_contiguous_id"] = stuff_dataset_id_to_contiguous_id
        meat["ignore_label"] = -1
        return meat

    elif dataset_name == 'whu_building':
        meat = {}
        stuff_dataset_id_to_contiguous_id = {}
        meat["classes"] = ["bg", "building"]
        meat["stuff_classes"] = ["bg", "building"]
        for i, _ in enumerate(meat["stuff_classes"]):
            stuff_dataset_id_to_contiguous_id[i] = i
        meat["stuff_dataset_id_to_contiguous_id"] = stuff_dataset_id_to_contiguous_id
        meat["ignore_label"] = -1
